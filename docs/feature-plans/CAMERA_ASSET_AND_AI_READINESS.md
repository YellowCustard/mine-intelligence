...
> **Requirements-meeting update (14 Sep 2026):** the estate is **118 Dahua** cameras (closed
> system). Primary integration is the **Dahua vendor/"backdoor" API + the NVR's existing AI
